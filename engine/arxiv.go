...
// ArxivEngine implements search using Arxiv API
type ArxivEngine struct {
	client *http.Client
}

// NewArxivEngine creates a new Arxiv engine instance
...
func (a *ArxivEngine) Name() string {
	return "arxiv"
}
...
// Search performs a search using Arxiv
